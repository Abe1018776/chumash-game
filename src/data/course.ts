...
export const COURSE: Unit[] = [
  {
    ...
    description: 'פרשת ויקרא — פּסוקים א–ה',
    color: '#009688',
    lessons: [
      {
        id: 'pasuk-1',
      ...
      },
      {
        ...
        unitId: 'unit-1',
        title: 'פּסוק ב',
        description: 'אָדָם כִּי יַקְרִיב...',
        pasukNumber: 2,
        ...
        wordIds: ['adam', 'korban', 'bakar', 'tzon'],
        unlocked: false,
      },
      {
        id: 'pasuk-3',
        ...
        wordIds: ['olah', 'zachar', 'tamim', 'petach', 'lirtzono'],
        unlocked: false,
      },
      // Pesukim 4–5 coming soon
    ],
  },
];
